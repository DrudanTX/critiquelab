...
export function LofiToggle() {
  ...
  const { focusMode, setFocusMode, toggleFocusMode } = useLofiMode();

  const isOgMode = !focusMode && theme === "light";
